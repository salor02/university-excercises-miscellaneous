...
//  "+" "+" "id" 
//added in fourth-level:
//  "id" "[" exp "]" "=" exp
//  "-" "-" "id" (due to inssort2.k)
assignment:
...
//  "{" stmts "}" 
block:
    "{" stmts "}"             { std::vector<BindingAST*> dummy; 
...
//modified in first-level:
//  removed blockexp    
//added in second-level: (due to eqn2.k)
//  "-" idexp 
//  "-" "number"
exp:
