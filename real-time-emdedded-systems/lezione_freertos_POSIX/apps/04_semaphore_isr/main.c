...
/* Demo includes. */
#include "utils.h"
#include "port_simulated_interrupt.h"

/* The number of the simulated interrupt used in this example. */
#define mainINTERRUPT_NUMBER	0
...
int main( void )
{
	...
	if( xBinarySemaphore != NULL )
	{
		...
		vPortStartSimulatedInterruptProcessing();
